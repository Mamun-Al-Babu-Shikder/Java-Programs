...
/*
 * Two matrix can be subtract if the row and column of those matrix are same.
 * Let's consider two matrix named first_matrix and second_matrix.
 * And result_matrix that hold the subtract value from first_matrix to second_matrix. 
...
public class SubtractionOfTwoMatrix {
	...
	public static void main(String[] args)
	{
		...
		/*
		 * Subtract and assign the subtract value to the result_matrix
		 */
		for(i=0;i<r;i++){
			for(j=0;j<c;j++) {
